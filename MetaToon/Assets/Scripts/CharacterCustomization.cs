    ...
    public class CharacterCustomization : Singleton<CharacterCustomization>
    {
        ...
        private void ParseBlendShapesToDictionary()
        {
            ...
            for (int i = 0; blendshapeNames.Count > 0;)
            {
                ...
                // Custom Code
                noSuffix = blendshapeNames[i].Trim();
                ...
                */
                ...
                //else
                if (blendshapeNames[i] == blendshapeNames[i].Trim())
                {
                ...
                // 22.10.10.
                // Can't search further than mouthOpen as of now.
                // why..?
                ...
                blendShapeDatabase.Add(noSuffix, new Blendshape(postiveIndex));
                ...
                if (noSuffix != string.Empty) blendshapeNames.Remove(noSuffix);
